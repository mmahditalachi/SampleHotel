...
namespace SampleHotel.Migrations
{
    ...
    [Migration("20230608203145_AddDependent")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleHotel.Models.Employee", b =>
                {
                    ...
                    b.Property<string>("DependentRelation")
                        .IsRequired()
                        .HasMaxLength(75)
                        .HasColumnType("nvarchar(75)");
            ...
            modelBuilder.Entity("SampleHotel.Models.LikedRoom", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LikedRoom", (string)null);
                });
            ...
            modelBuilder.Entity("SampleHotel.Models.LikedRoom", b =>
                {
                    b.HasOne("SampleHotel.Models.Room", null)
                        .WithMany()
